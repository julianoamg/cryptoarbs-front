...
<div class="flex flex-col items-center">
    <div class="w-full max-w-5xl space-y-6">
        <PageHeader 
            ...
            description="Gerencie as chaves de API das suas corretoras"
            icon={Key}
        />
