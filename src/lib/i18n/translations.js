export const translations = {
    'pt-BR': {
        ...
        menu: {
            ...
            estrategia: 'Robô',
            operacoes: 'Operações',
            credenciais: 'Credenciais de API',
            suporte: 'SUPORTE',
        ...
        pages: {
            ...
            strategy: {
                ...
                cardTitle: 'Configurações do Robô',
                ...
                stake: 'Stake',
                stakeDescription: 'Valor em USDT para operações (5.0-100.0). Este valor será usado em cada exchange, totalizando o dobro.',
                saveButton: 'Salvar Configurações',
    ...
    'en': {
        ...
        pages: {
            ...
            strategy: {
                title: 'Robot',
                subtitle: 'Configure your arbitrage robot parameters',
                cardTitle: 'Robot Settings',
    ...
    'es': {
        ...
        menu: {
            ...
            analiseSentimental: 'Análisis Sentimental',
            configuracoes: 'Configuraciones',
            arbify: 'ARBIFY',
            estrategia: 'Robot',
            operacoes: 'Operaciones',
            credenciais: 'Credenciales de API',
            suporte: 'SOPORTE',
        ...
        pages: {
            ...
            strategy: {
                title: 'Robot',
                subtitle: 'Configura los parámetros de tu robot de arbitraje',
                cardTitle: 'Configuraciones del Robot',
